...
DROP TABLE IF EXISTS nida_verifications CASCADE;
DROP TABLE IF EXISTS nida CASCADE;
...
CREATE TABLE nida_verifications (
    ...
    FOREIGN KEY (nida_number) REFERENCES nida(nida_number) ON DELETE CASCADE
);

-- Add indexes
CREATE INDEX idx_nida_number ON nida(nida_number);
CREATE INDEX idx_nida_verifications_nida_number ON nida_verifications(nida_number); 